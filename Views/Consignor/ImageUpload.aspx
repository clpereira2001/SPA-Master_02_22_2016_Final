...
<body>
   ...
   {%>
<div style="padding:5px;color:#800000;border:dotted 1px #800000; margin:10px 0px 20px 0px; font-family: Arial, Helvetica, sans-serif; font-size: 14px;"><%=ViewData["Error"] %></div>
<%} %>--%>

  <% List<string> Lst = ViewData["Images"] as List<string>;
     string path = AppHelper.GetSiteUrl("/public/AuctionImages/UserImages/" + AppHelper.CurrentUser.ID.ToString() + "/");
  string completeURL; %>        
  <div id="dvMain">
   ...
   <tr class="btns">
      <%for (int i = 0; i < Lst.Count; i++)
        ...
        <td style="padding-right:0px;">
          ...
          <% using (Html.BeginForm("ImageUpload", "Consignor", FormMethod.Post, new { enctype = "multipart/form-data" })){%>
